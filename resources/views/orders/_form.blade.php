...
@if(isset($clients))
    <div class="input-field col s12">
        {{ Form::select('client_id', $clients, null, ['placeholder' => 'Выберите клиента', 'required', 'style' => 'display:none']) }}
        {{ Form::text('client_name', $order->client->name)}}
...
@if(isset($types))
    <div class="input-field col s12">
        ...
        {{ Form::text('type_name', $current['type']->name)}}
    ...
    <div class="input-field col s12">
        ...
        {{ Form::text('brend_name', $current['brend']->name)}}
    ...
    <div class="input-field col s12">
        ...
        {{ Form::text('model_name', $order->lmodel->name)}}
...
<script>$('form .materialized select').material_select();</script>